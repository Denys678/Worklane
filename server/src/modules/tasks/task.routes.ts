...
import { createTaskSchema, moveTaskSchema, taskIdParamsSchema, taskQuerySchema, updateTaskSchema } from "./task.schema.js";
...
router.get("/:projectId/tasks", authenticate, validateRequest(taskQuerySchema, "query"), validateRequest(projectIdParamsSchema, "params"), getProjectTasksController);
